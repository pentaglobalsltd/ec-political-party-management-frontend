...
import { fetchPollingCenterListForAro } from '@api/result-management/electoral-process/results/get-polling-center-list';
...
export const useGetPollingCenterListForAro = () => {
  ...
  const getPollingCenterListForAro = async ({
    scheduleId,
    electionSettings,
    status,
    page = 0,
