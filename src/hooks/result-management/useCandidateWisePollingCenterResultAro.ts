...
import { RESULT_POLLING_CENTER_DASHBOARD_OPTIONS_COLORS_FOR_ARO_DASHBOARD } from '@constants/polling-center-results';
import {
...
const getBgColor = (status?: string) => {
  if (
    status &&
    RESULT_POLLING_CENTER_DASHBOARD_OPTIONS_COLORS_FOR_ARO_DASHBOARD.makeBgGreen.includes(
      status,
    )
  )
    return 'bg-success';
    ...
    status &&
    RESULT_POLLING_CENTER_DASHBOARD_OPTIONS_COLORS_FOR_ARO_DASHBOARD.makeBgYellow.includes(
      status,
    )
  )
    ...
    status &&
    RESULT_POLLING_CENTER_DASHBOARD_OPTIONS_COLORS_FOR_ARO_DASHBOARD.makeBgGray.includes(
      status,
    )
  )
    return 'bg-light';
    ...
    status &&
    RESULT_POLLING_CENTER_DASHBOARD_OPTIONS_COLORS_FOR_ARO_DASHBOARD.makeBgRed.includes(
      status,
    )
  )
...
const mappedSortingDataArray = (dataArray: any) => {
  ...
  return [...yellowItems, ...greenItems, ...grayItems, ...redItems];
};
...
export const useCandidateWisePollingCentersDetailsListAro = () => {
