...
import { GetPollingPotentialPollingCentersApiNew } from '@api/vote-center-management/center-management/polling-center-list/potential-polling-center-polling-center-service';
...
const usePotentialPollingCentersPollingCenterService = ({
  setContextData,
...
export default usePotentialPollingCentersPollingCenterService;
