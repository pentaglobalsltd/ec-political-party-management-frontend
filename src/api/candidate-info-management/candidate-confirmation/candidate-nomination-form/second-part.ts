...
import { SecondPartPropType } from '@type/candidate-info-management/operator-view/candidate-nomination-form/second-part';
...
export const getCandidateNominationFormSecondPart = (() => {
  ...
  }: UrlIdTypes): Promise<{ data: SecondPartPropType }> => {
