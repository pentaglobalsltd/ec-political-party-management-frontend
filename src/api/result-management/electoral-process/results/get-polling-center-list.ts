...
export const fetchPollingCenterList = (() => {
  ...
  return async ({
    ...
    const url = encodeQuery(
      URLS.POLLING_CENTER_RESULT_LIST(scheduleId, electionSettings),
      {
        ...(page && { page: page }),
        ...(size && { size: size }),
...
export const fetchPollingCenterListForAro = (() => {
  ...
  return async ({
    ...
    const url = encodeQuery(
      URLS.POLLING_CENTER_RESULT_LIST_FOR_ARO(scheduleId, electionSettings),
      {
        ...(page && { page: page }),
        ...(size && { size: size }),
        ...(status && { status: status }),
...
export const fetchPollingCenterListForAroSummary = (() => {
  const cancelToken = axios.CancelToken;
  let source = cancelToken.source();
  let isRequestInProcess = false;
  ...
  return async ({
    ...
    const url = encodeQuery(
      URLS.POLLING_CENTER_LIST_FOR_ARO_SUMMARY(
        scheduleId,
        candidateTypeId,
        userId,
      ),
