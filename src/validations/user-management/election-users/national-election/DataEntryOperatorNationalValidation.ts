...
export const dataEntryOperatorNationalValidation = yup.object().shape({
...
export type DataEntryOperatorDataType = yup.InferType<
  typeof dataEntryOperatorNationalValidation
>;
