...
export const assistantReturningOfficerNationalValidation = yup.object().shape({
  ...
  [ASSISTANT_RETURNING_OFFICER.ELECTION_SETTINGS]: SelectMultiselectValidation(
    'CREATE_NEW_USER_ERROR_MSG.ARO_CONSTITUENCY',
  ),
...
export type AssistantReturningOfficerDataType = yup.InferType<
  typeof assistantReturningOfficerNationalValidation
>;
