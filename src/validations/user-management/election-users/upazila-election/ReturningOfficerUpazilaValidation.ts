...
export const returningOfficerUpazilaValidation = yup.object().shape({
  ...
  [RETURNING_OFFICER.UPAZILA]: SelectMultiselectValidation(
    'CREATE_NEW_USER_ERROR_MSG.RETURNING_OFFICER_UPAZILA',
  ),
});

export type ReturningOfficerUpazilaValidationDataType = yup.InferType<
  typeof returningOfficerUpazilaValidation
>;
