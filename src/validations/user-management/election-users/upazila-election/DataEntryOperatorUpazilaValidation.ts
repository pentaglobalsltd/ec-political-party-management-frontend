...
export const dataEntryOperatorUpazilaValidation = yup.object().shape({
  ...
  [DATA_ENTRY_OPERATOR.UPAZILA]: SelectMultiselectValidation(
    'CREATE_NEW_USER_ERROR_MSG.DATA_ENTRY_OP_UPAZILA',
  ),
});

export type DataEntryOperatorUpazilaDataType = yup.InferType<
  typeof dataEntryOperatorUpazilaValidation
>;
