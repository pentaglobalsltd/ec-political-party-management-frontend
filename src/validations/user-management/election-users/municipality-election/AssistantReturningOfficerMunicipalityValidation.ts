...
export const assistantReturningOfficerMunicipalityValidation = yup
  .object()
  .shape({
...
export type AssistantReturningOfficerMunicipalityValidationDataType =
  yup.InferType<typeof assistantReturningOfficerMunicipalityValidation>;
