...
export const returningOfficerMunicipalityValidation = yup.object().shape({
  ...
  [RETURNING_OFFICER.MUNICIPALITY]: SelectMultiselectValidation(
    'CREATE_NEW_USER_ERROR_MSG.RETURNING_OFFICER_MUNICIPALITY_ONLY',
  ),
});

export type ReturningOfficerMunicipalityValidationDataType = yup.InferType<
  typeof returningOfficerMunicipalityValidation
>;
