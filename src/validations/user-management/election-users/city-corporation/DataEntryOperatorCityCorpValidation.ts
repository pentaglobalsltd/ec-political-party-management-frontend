...
export const dataEntryOperatorCityCorpValidation = yup.object().shape({
  ...
  [DATA_ENTRY_OPERATOR.MUNICIPALITY]: SelectMultiselectValidation(
    'CREATE_NEW_USER_ERROR_MSG.DATA_ENTRY_OP_MUNICIPALITY',
  ),
  [DATA_ENTRY_OPERATOR.ELECTION_SETTINGS]: SelectMultiselectValidation(
    'CREATE_NEW_USER_ERROR_MSG.DATA_ENTRY_OP_SETTINGS',
  ),
});

export const dataEntryOperatorCityCorpMayorValidation = yup.object().shape({
  [DATA_ENTRY_OPERATOR.ELECTION_SETTINGS]: yup.array().nullable(),
});

export type DataEntryOperatorCityCorpDataType = yup.InferType<
  typeof dataEntryOperatorCityCorpValidation
>;
