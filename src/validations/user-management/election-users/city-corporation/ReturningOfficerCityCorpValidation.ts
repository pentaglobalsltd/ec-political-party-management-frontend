...
export const returningOfficerCityCorpValidation = yup.object().shape({
  ...
  [RETURNING_OFFICER.MUNICIPALITY]: SelectMultiselectValidation(
    'CREATE_NEW_USER_ERROR_MSG.RETURNING_OFFICER_MUNICIPALITY',
  ),
});

export type ReturningOfficerCityCorpValidationDataType = yup.InferType<
  typeof returningOfficerCityCorpValidation
>;
