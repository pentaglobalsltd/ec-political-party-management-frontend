...
export const CANDIDATE_INFO_MANAGEMENT_ROUTES = {
  // Nomination Of Candidates
  CANDIDATE_NOMINATION: '/candidate-info-management/nomination-of-candidates',
  NOMINATION_OF_CANDIDATES: 'nomination-of-candidates',
  CREATE_NEW_NOMINATION_OF_CANDIDATE:
    '/candidate-info-management/nomination-of-candidates/create',
  EDIT_NOMINATION_OF_CANDIDATE: ({
    ...
    `/candidate-info-management/nomination-of-candidates/${electionSettingsId}/${candidateElectionDetailsId}/${electionTypeId}/${candidateTypeId}/${scheduleId}/${isFromNominationPage}`,
  ...
  EDIT_CANDIDATE_MANAGEMENT: (id: string | number) => `${id}`,
  ...
  VIEW_CANDIDATE_MANAGEMENT: ({
    ...
    `/candidate-info-management/candidate-management/view-candidate-management/${electionSettingsId}/${candidateElectionDetailsId}/${electionApplicantId}/${electionTypeId}/${candidateTypeId}`,
  ...
  VIEW_CANDIDATE_STATUS_HISTORY: ({
    ...
    `/candidate-info-management/candidate-management/view-candidate-status-history/${electionSettingsId}/${candidateElectionDetailsId}/${electionTypeId}/${candidateTypeId}`,
  ...
  CANDIDATES_APPLIED_ONLINE_SUMMARY: ({
    ...
    `/candidate-info-management/candidates-applied-online/candidates-summary/${electionSettingsId}/${candidateElectionDetailsId}/${electionApplicantId}/${electionTypeId}/${scheduleId}/${candidateTypeId}`,
  ...
  EDIT_DYNAMIC_REPORT: (id: string | number) => `${id}`,
