...
export const allSelectedDataSettings = {
  electionType: false,
...
export const searchStructSettings = [
  {
...
export const searchStructSettingsCityCorporationOp = [
  {
    fieldName: ADVANCE_SEARCH.ELECTION_TYPE,
    apiService: API_SERVICE.MASTER,
  },
...
export const searchStructSettingsUpazilaElectionOfficer = [
  {
    fieldName: ADVANCE_SEARCH.ELECTION_TYPE,
    apiService: API_SERVICE.MASTER,
  },
