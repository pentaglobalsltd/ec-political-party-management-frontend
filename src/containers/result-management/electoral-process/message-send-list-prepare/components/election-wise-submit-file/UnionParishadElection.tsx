...
import { useCreateSendingMessageListPrepareForUnion } from '@hooks/result-management/electoral-process/message-sending-list-prepare/useCreateSendingMessageListPrepareForUnion';
...
export default function UnionParishadElection({
  ...
  const { addSendingMessageListPrepare, loading, success } =
    useCreateSendingMessageListPrepareForUnion();
