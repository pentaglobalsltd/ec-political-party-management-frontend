...
import { SUBMIT_RESULTS } from '../candidateWiseComponent';
...
export const UnionParishadElection = ({
  ...
  const unionWatch = watch(SUBMIT_RESULTS.UNION_OR_WARD);
  ...
  return (
    <>
      {isChairman ? (
        ...
        <form className="w-50 d-flex justify-content-around gap-5 mx-5">
          <div className="w-50">
            <Select
              title="SEARCH.UNION_OR_WARD"
