...
import { newNominationLetterBreadcrumbs, options } from '../constants';

const NOMINATION_LETTER =
  FORM_FIELDS.ELECTION_SCHEDULE_MANAGEMENT.ELECTION.NOMINATION_LETTER;

function CreateNominationLetter() {
  ...
  const submitNominationForm = (data: any) => {
    console.log(data);
  };
  ...
  return (
    <div className="container-96 mb-24">
      <Header
        headerText={{
          header: t('NOMINATION_LETTER.ADD_NOMINATION_LETTER'),
        }}
        breadcrumbs={newNominationLetterBreadcrumbs(t)}
        className="mb-12 pt-10"
      />
      <FormProvider {...methods}>
        <form onSubmit={handleSubmit(submitNominationForm)}>
          ...
          <div className="d-flex justify-content-end align-items-center gap-6 border-top pt-8">
            <Button
              ...
              htmlType="button"
              type="info"
              onClick={resetNominationForm}
            >
              {t('NOMINATION_LETTER.RESET')}
...
export default CreateNominationLetter;
