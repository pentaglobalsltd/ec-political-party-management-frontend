...
export const inputs = {
  ...
  district: {
    ...
    nonRefreshData: {
      district: false,
      electionScheduleConstituencyOptions: false,
      electionScheduleUpazilaOptions: false,
      electionScheduleMayorMunicipalitiesOptions: false,
      electionScheduleCouncilorMunicipalitiesOptions: false,
    },
  },
  electionScheduleConstituency: {
    parents: [
      {
    ...
    nonRefreshData: {
      electionScheduleConstituency: false,
    },
  },
  electionScheduleUpazila: {
    parents: [
      {
        name: 'electionTypeMaster',
    ...
    nonRefreshData: {
      electionScheduleUpazila: false,
    },
  },
  electionScheduleMayorMunicipalities: {
    parents: [
      {
        name: 'electionTypeMaster',
        value: [
    ...
    nonRefreshData: {
      electionScheduleMayorMunicipalities: false,
    },
  },
  electionScheduleCouncilorMunicipalities: {
    parents: [
      {
        name: 'electionTypeMaster',
        value: [
    ...
    nonRefreshData: {
      electionScheduleCouncilorMunicipalities: false,
      electionScheduleUnionOrWardOptions: false,
    },
  },
  electionScheduleUnionOrWard: {
    parents: [
      {
        name: 'electionTypeMaster',
        value: [
    ...
    nonRefreshData: {
      electionScheduleUnionOrWard: false,
    },
  },
  rearrangeSeat: {},
  case: {},
...
export const searchStruct = [
  ...
  },
  {
    ...
    refreshData: { ...clearUpazilaOrThanas },
    nonRefreshData: {
      municipality: false,
