...
const CreateZillaWard = () => {
  ...
  return (
    <div className="container-96 mb-24">
      <Header
        headerText={{ header: t('ZILLA_WARD.ADD_ZILLA_WARD') }}
        breadcrumbs={addNewZillaWardBreadcrumbs(t)}
...
export default CreateZillaWard;
