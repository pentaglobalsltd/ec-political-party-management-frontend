...
import { options, editedDistrictReservedSeatsBreadcrumbs } from '../constants';
...
function EditDistrictReservedSeats() {
  ...
  const updateDistrictReservedSeatsForm = (data: any) => {
    console.log(data);
  };
  ...
  return (
    <div className="container-96 mb-24">
      <FormProvider {...methods}>
        <form onSubmit={handleSubmit(updateDistrictReservedSeatsForm)}>
          <Header
            className="mb-10 pt-10"
            headerText={{
              header: t('DISTRICT_RESERVED_SEATS.CHANGE'),
            }}
            breadcrumbs={editedDistrictReservedSeatsBreadcrumbs(t)}
          />
          ...
          <div className="d-flex justify-content-end align-items-center gap-6 border-top py-8">
            <Button fill="outline" key={1} htmlType="button" type="dark">
              {t('DISTRICT_RESERVED_SEATS.BACK')}
            </Button>
...
export default EditDistrictReservedSeats;
