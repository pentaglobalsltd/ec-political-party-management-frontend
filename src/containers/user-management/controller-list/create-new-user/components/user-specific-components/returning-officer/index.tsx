...
export const ReturningOfficer = ({
  ...
  const electionTypeWatch = watch(
    ELECTION_USER.RETURNING_OFFICER.TYPE_OF_ELECTION,
  );
  const electionScheduleWatch = watch(
    ELECTION_USER.RETURNING_OFFICER.ELECTION_NAME,
  );
  ...
  return (
    <div>
      ...
      <FormSelect
        title={t('ELECTION_USER.RETURNING_OFFICER.TYPE_OF_ELECTION')}
        name={ELECTION_USER.RETURNING_OFFICER.TYPE_OF_ELECTION}
      ...
      <FormSelect
        title={t('ELECTION_USER.RETURNING_OFFICER.ELECTION_NAME')}
        name={ELECTION_USER.RETURNING_OFFICER.ELECTION_NAME}
