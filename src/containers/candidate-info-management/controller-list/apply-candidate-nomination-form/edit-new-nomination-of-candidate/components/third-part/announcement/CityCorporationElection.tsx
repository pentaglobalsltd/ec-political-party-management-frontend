    ...
    <div className="rounded-4 bg-info-50 px-9 py-9 my-9">
      ...
      <div className="pt-7">
        <Text size="sm" color="title" weight="medium">
          <Trans
            i18nKey={`THIRD_PART.ANNOUNCEMENT_FIRST_PART.CITY_CORPORATION_ELECTION`}
            components={{
      ...
      {/* ৪) */}
      <FormInput
        title="THIRD_PART.TIN_NO.CITY_CORPORATION_ELECTION"
      ...
      <div className="pb-7">
        <Text size="sm" color="title" weight="medium">
          <Trans
            i18nKey={`THIRD_PART.ANNOUNCEMENT_SECOND_PART.CITY_CORPORATION_ELECTION`}
            components={{
              d: <div className="pb-7"></div>,
            }}
          ></Trans>
        ...
        <>
          <div className="py-3 mb-6">
            <Text weight="semibold" color="title">
              {t('THIRD_PART.ME.CITY_CORPORATION_ELECTION')} {candidateName}
            </Text>
          </div>
          ...
          <div className="d-grid grid-cols-12">
            <div className="col-span-3">
              <Text size="sm" weight="medium" color="title">
                {t(
                  'THIRD_PART.POLITICAL_GROUP_CHECKBOX.CITY_CORPORATION_ELECTION',
                )}
              </Text>
            </div>
          ...
          <Text size="sm" color="title" weight="medium">
            <Trans
              i18nKey={`THIRD_PART.ANNOUNCEMENT_THIRD_PART.CITY_CORPORATION_ELECTION`}
              components={{
                d: <div className="pb-7"></div>,
              }}
            ></Trans>
      ...
      <FormInput
        title={`THIRD_PART.BANK_ACCOUNT_NO.CITY_CORPORATION_ELECTION.${candidateTypeKey}`}
      ...
      {/* ৭) for mayor and ৬) for councillor and reserved councillor */}
      <FormSelect
        title="THIRD_PART.BANK_NAME.CITY_CORPORATION_ELECTION"
      ...
      {/* ৭) for mayor and ৬) for councillor and reserved councillor */}
      <FormInput
        title="THIRD_PART.BRANCH_NAME.CITY_CORPORATION_ELECTION"
      ...
      <Text size="sm" color="title" weight="medium">
        <Trans
          i18nKey={`THIRD_PART.ANNOUNCEMENT_FORTH_PART.CITY_CORPORATION_ELECTION.${candidateTypeKey}`}
          components={{
            d: <div className="pb-7"></div>,
          }}
        ></Trans>
