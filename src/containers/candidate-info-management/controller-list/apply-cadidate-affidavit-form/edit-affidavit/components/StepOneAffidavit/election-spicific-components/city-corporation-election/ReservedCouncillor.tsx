...
const ReservedCouncillor = ({
  ...
  return (
    <>
      ...
      <FormInput
        title="AFFIDAVIT_STEP_ONE.CANDIDATE_ADDRESS"
        registerName={`candidatePersonalInfo.${FIRST_STEP_AFFIDAVIT.CANDIDATE_ADDRESS}`}
        placeholder="PLACEHOLDER.ENTER"
        disabled
      />
...
export default ReservedCouncillor;
