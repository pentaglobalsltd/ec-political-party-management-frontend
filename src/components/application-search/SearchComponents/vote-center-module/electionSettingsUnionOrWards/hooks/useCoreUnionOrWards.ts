...
import { apiGetCoreUnionsOrWards } from '../api/unions-wards-core';

export const useCoreElectionSettingsUnionsOrWards = () => {
  ...
  const getUnionsOrWardsData = async ({
    ...
    try {
      ...
      const response = await apiGetCoreUnionsOrWards(params, filter);
